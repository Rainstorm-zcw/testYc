 ...
 * @date 2019-05-08
 */
public class MainGenerator implements CommentGenerator {
     ...
     */
    public MainGenerator(Configuration configuration, ShellCallback shellCallback,
    ...
    public void generate(ProgressCallback callback, Set<String> contextIds,
        ...
        for (GeneratedXmlFile gxf : generatedXmlFiles) {
            ...
            try {
                ...
                source = gxf.getFormattedContent(); // xml直接覆盖！好危险的样子
